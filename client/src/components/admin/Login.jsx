    ...
    <div className='flex items-center justify-center h-screen'>
      ...
      <div className='flex flex-col items-center justify-center'>
        <div className='w-full py-6 text-center'>
          ...
          <div className='font-light'>Enter your credentials to access the admin panel</div>
        </div>
...
<button type="submit" className='w-full py-3 font-medium bg-primary text-white rounded cursor-pointer hover:bg-primary/90 I
